    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Rp 5.999.000</td>
          <td>SoC Exynos 1480 yang didukung GPU berteknologi AMD yang mumpuni</td>
        </tr>
        <tr>
          <th scope="row">2</th>
          <td>Samsung Galaxy A35 5G</td>
          <td>Rp 4.999.000 </td>
          <td>Cocok untuk gaming dan keseharian, performa Exynos 1380 cukup tangguh</td>
        </tr>
        <tr>
          <th scope="row">3</th>
          <td>Samsung Galaxy XCover 7</td>
          <td>Rp 4.999.000</td>
          <td>Punya sertifikasi ketahanan militer, tahan terhadap benturan</td>
        </tr>
      </tbody>
    </table>
